    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 text-center px-5">
      ...
      <div className="max-w-xl bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="flex justify-center space-x-4">
          <Link
            to="/todos"
            className="flex items-center gap-2 bg-blue-800 text-white px-5 py-2 rounded-md font-semibold hover:bg-blue-900 transition"
          >
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl">
        <div className="p-6 bg-white shadow-lg rounded-lg flex flex-col items-center">
          <AiOutlineCheckCircle className="text-blue-800 text-4xl mb-3" />
        ...
        <div className="p-6 bg-white shadow-lg rounded-lg flex flex-col items-center">
          <BsFillClipboardDataFill className="text-blue-800 text-4xl mb-3" />
        ...
        <div className="p-6 bg-white shadow-lg rounded-lg flex flex-col items-center">
          <AiOutlineLogin className="text-blue-800 text-4xl mb-3" />
